...
const TopSellingCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="relative w-full max-w-xs bg-white border overflow-hidden mx-auto group hover:border-red-900 transition-shadow duration-300">
      ...
      <div className="absolute bottom-[-100px] left-0 w-full h-10 bg-black text-white text-center py-2 opacity-0 group-hover:opacity-100 group-hover:bottom-0 transition-all duration-300">
        <button className="w-40 bg-red-600 text-white hover:bg-white hover:text-red-600 hover:border-2 hover:border-red-600 rounded-lg font-semibold ">
          Add to Cart
        </button>
      </div>
    </div>
